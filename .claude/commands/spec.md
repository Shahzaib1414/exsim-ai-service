...
1. `feature_title`  
   ...
   - Example: "Auth module for Authentication".
...
3. `branch_name`  
   ...
   - Example: `claude/feature/auth-module`.
...
Create a markdown spec document that Plan mode can use directly and save it in the @.claude/_specs folder using the `feature_slug`. Use the exact structure as defined in the spec template file here: @.claude/_specs/template.md. Do not add technical implementation details such as code examples.
